      ...
      <div style={{ marginBottom: 4 }}>
        {price !== null && price > 0 ? (
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
            <span style={{ fontSize: 36, fontWeight: 700, color: '#1c1917', fontFamily: "'Satoshi', sans-serif" }}>
    ...
    <div className="landing-root">
      ...
      <div style={{ maxWidth: 1120, margin: '0 auto', padding: '120px 24px 80px', fontFamily: "'Satoshi', sans-serif" }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <h1 style={{ fontSize: 38, fontWeight: 700, color: '#1c1917', margin: '0 0 12px', lineHeight: 1.2 }}>
        ...
        <div style={{ maxWidth: 640, margin: '64px auto 0' }}>
          <h2 style={{ fontSize: 24, fontWeight: 700, color: '#1c1917', textAlign: 'center', marginBottom: 32 }}>
